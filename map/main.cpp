...
void reverse_iterator_tests(void)
{
    ...
    ft::rbidirectional_iterator<std::map<int, char>::iterator> my_rit(m.end()), my_rit1(--m.end());
    /*----------------------------------*/
    std::cout << "\t\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor "
              << "] --------------------]\t\t\033[0m";
    {
        ft::rbidirectional_iterator<std::map<int, char>::iterator> ob(my_rit);
        EQUAL(*my_rit == *ob);
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::rbidirectional_iterator<std::map<int, char>::iterator> my_tmp(my_rit++);
